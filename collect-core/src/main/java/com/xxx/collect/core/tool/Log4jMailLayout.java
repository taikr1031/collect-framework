...
public class Log4jMailLayout extends Layout {
  ...
  public String format(LoggingEvent event) {
    ...
    sbuf.append("" + Transform.escapeTags(event.getRenderedMessage()) + "<br>" + Layout.LINE_SEP);
    sbuf.append("Time: " + DateUtil.getNowTimeDesc("yyyy-MM-dd HH:mm:ss") + "<br>" + Layout.LINE_SEP);
